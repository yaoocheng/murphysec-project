    ...
    <div class="timing g-color-1 g-bg-f7 g-p-16 g-bdr-6">
        ...
        <div v-if="!isConfig">
            <div class="g-p-16 g-bdr-6 g-bg-ff g-mb-16">
                ...
                <div class="g-mb-16">
                    ...
                    <el-select v-model="(detectInfo).repo_type" placeholder="请选择仓库类型" style="width: 370px;">
                        <el-option label="半成品库" value="snapshot" />
                        <el-option label="成品库" value="release" />
                        <!-- <el-option label="镜像库" value="mirror" /> -->
                    </el-select>
                </div>
                ...
                <el-select v-model="detectInfo.repo_format" placeholder="请选择制品类型" style="width: 370px;">
                    <el-option
                        v-for="item in artifactTypes"
                        :key="item.id"
                        :label="item.showName"
                        :value="item.repoFormat"
                    />
                </el-select>
            </div>
        ...
        <div v-else>
            <div class="g-p-16 g-bdr-6 g-bg-ff g-mb-16 g-fw-500">
                ...
                <div class="g-mb-8">仓库类型</div>
                <div class="g-fw-400 g-mb-16">{{ getRepoFormatText((detectInfo as any).repo_type) || '-' }}</div>

                <div class="g-mb-8">制品类型</div>
                <div class="g-fw-400 g-mb-16">{{ getArtifactTypeText((detectInfo as any).repo_format) || '-' }}</div>
            </div>
...
const artifactTypes = [
    {
        id: '1',
        repoFormat: 'raw',
        repoIcon: 'https://resource.ezone.work/static/icons/img/raw.png',
        showName: 'File',
    },
    {
        id: '2',
        repoFormat: 'maven',
        repoIcon: 'https://resource.ezone.work/static/icons/img/maven.png',
        showName: 'Maven',
        enabled: true,
    },
    {
        id: '3',
        repoFormat: 'docker',
        repoIcon: 'https://resource.ezone.work/static/icons/img/docker.png',
        showName: 'Docker',
        enabled: true,
    },
    {
        ...
        companyId: '19605',
        repoFormat: 'helm',
        repoIcon: 'https://resource.ezone.work/static/icons/img/helm.png',
        showName: 'Helm',
        enabled: true,
    },
    {
        id: '5',
        repoFormat: 'npm',
        repoIcon: 'https://resource.ezone.work/static/icons/img/npm.png',
        showName: 'Npm',
        enabled: true,
    },
    {
        id: '6',
        repoFormat: 'pypi',
        repoIcon: 'https://resource.ezone.work/static/icons/img/PyPI.png',
        showName: 'PyPI',
        enabled: true,
    },
    {
        id: '7',
        repoFormat: 'composer',
        repoIcon: 'https://resource.ezone.work/static/icons/img/Composer.png',
        showName: 'Composer',
        enabled: true,
    },
    {
        id: '9',
        repoFormat: 'nuget',
        repoIcon: 'https://resource.ezone.work/static/icons/img/NuGet.png',
        showName: 'NuGet',
        enabled: true,
    },
    {
        id: '10',
        repoFormat: 'conan',
        repoIcon: 'https://resource.ezone.work/static/icons/img/Conan.png',
        showName: 'Conan',
        enabled: true,
    },
    {
        id: '11',
        repoFormat: 'apk',
        repoIcon: 'https://resource.ezone.work/static/icons/img/apk.png',
        showName: 'Apk',
        enabled: true,
    },
    {
        id: '12',
        repoFormat: 'ipa',
        repoIcon: 'https://resource.ezone.work/static/icons/img/ipa.png',
        showName: 'Ipa',
        enabled: true,
    },
    {
        id: '15',
        repoFormat: 'ohpm',
        repoIcon: '/static/icons/img/ohpm.png',
        showName: 'OHPM',
        enabled: true,
    },
];
...
// 获取制品类型文本
const getArtifactTypeText = (type: string) => {
    const artifact = artifactTypes.find((item) => item.repoFormat === type);
    return artifact ? artifact.showName : type;
};
...
const getTimeConfig = async (id: string) => {
    try {
        const { data } = await getDetectConfigApi({
            team_config_id: id,
            access_type: 'ezone_package',
            config_type: 'cron',
        });
        detectInfo.crontab_spec = '';
        (detectInfo).repo_format = '';
        (detectInfo).repo_type = '';
...
const nextStepHandle = () => {
    ...
    detectInfo.access_type = 'ezone_package';
    detectInfo.config_type = 'cron';
    router.push('/detect-config?from=ezone_package&type=detectConfig');
};
