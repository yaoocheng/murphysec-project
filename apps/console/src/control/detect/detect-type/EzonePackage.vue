<template>
    <div class="top_btn">
        ...
        <el-button v-if="isUserSpace || normalTeamAuth" @click="$router.push(`/detect-access?from=ezone_package`)"
                   class="main_btn ">
            新增集成
        </el-button>
    </div>
...
import List from './ezone-package/List.vue';
import Cron from './ezone-package/Cron.vue';
...
detectInfo.team_config_id = route.query.config_id || store.allAccessInfo.ezone_package[0]?.config_id;
