    ...
    <div class="access_tab">
        ...
        <FormComp label-position="top" label-width="135px">
            ...
            <el-form-item prop="address">
                ...
                <el-select style="width: 500px" v-model="formData.versions">
                    <el-option v-for="(item, index) in versionOptions" :key="index" :label="item.label" :value="item.data"></el-option>
                </el-select>
            </el-form-item>
        ...
        <div class="video" v-if="!$systemConfig.isClose">
            <video :src="`${origin}/files/video/harbor-tutorial-video.mp4`"
                   width="568" height="342" controls
                   :poster="`${origin}/files/video/harbor-tutorial-cover.jpg`"></video>
            <div class="video_text">
                视频教程是否对你有帮助？如有疑问您可以查看
                <a href="/docs/faqs/integration/harbor.html" target="_blank">文档说明 <i
...
const saveHandle = async () => {
    ...
    try {
        ...
        router.push('/detect-main?from=harbor');
    } catch (error) {
        console.log(error);
    }
};
