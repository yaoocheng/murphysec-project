<template>
    <div class="access_tab">
        ...
        <!-- <div class="video" v-if="!$systemConfig.isClose">
            <video :src="`${origin}/files/video/folib-tutorial-video.mp4`"
                width="568" height="342" controls
                :poster="`${origin}/files/video/folib-tutorial-cover.jpg`"></video>
            <div class="video_text">
                视频教程是否对你有帮助？如有疑问您可以查看
                <a href="/docs/faqs/integration/folib.html" target="_blank">文档说明 <i
...
const saveHandle = async () => {
    ...
    try {
        ...
        router.push('/detect-main?from=folib');
    } catch (error) {
        console.log(error);
    }
};
