<template>
    <div class="email_notice">
        ...
        <div class="desc">
            当检测结果达到设置的处置条件时，通过邮箱进行消息通知
        </div>
        <div>
            <el-input disabled v-model="getUserInfo().email" style="width: 500px;"></el-input>
        </div>
        <div style="margin-top: 20px;">
            <span style="margin-right: 10px;">开启/关闭</span>
            <SwitchComp v-model="detectInfo.notice_self_email_disable" />
        </div>
    </div>
</template>
