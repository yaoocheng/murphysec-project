<template>
    <div class="filter_wrap">
        <div>
            ...
            <SelectComp style="width: 150px;" v-model="filterOptions.action" placeholder="处置动作"
                        :options="disposeOptions" />
            <!-- <el-cascader style="width: 150px;" v-model="selectOrg" @change="selectOrgHandle" :props="props" placeholder="所属组织"
                class="g-mr-8" /> -->
...
<el-button @click="isShowEdit = true; editData = initEditData">添加</el-button>
    ...
    <div class="table_wrap">
        <el-table height="100%" :cell-style="{ height: '48px' }" :data="listData" @selection-change="selectHandle"
            ...
            <el-table-column label="所属组织" width="130" prop="org_name" show-overflow-tooltip />
            <!-- <el-table-column label="所属团队" width="140" prop="team_name" show-overflow-tooltip /> -->
            <el-table-column label="策略开启" width="130">
                <template #default="scope">
