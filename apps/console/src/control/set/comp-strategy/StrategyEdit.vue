<template>
    <el-dialog width="1036px" top="32px" :title="`${editData.name ? '编辑' : '添加'}组件策略`"
                ...
                <div class="form">
                    <FormComp label-position="top" :hide-required-asterisk="false">
                        <el-form-item :required="true" label="策略名称">
                            <div style="width: 100%;">
                                <el-input v-model="formData1.name" maxlength="30" show-word-limit
                        ...
                        <el-form-item label="策略说明">
                            <div style="width: 100%;">
                                <el-input type="textarea" maxlength="500" show-word-limit resize="none"
                                          v-model="formData1.desc" placeholder="请输入策略说明"></el-input>
                            </div>
                        </el-form-item>
                        ...
                        <el-form-item :required="true">
                            <template #label>
                                ...
                                <el-tooltip placement="top">
                                    ...
                                    <i style="font-size: 14px;cursor:pointer;pointer-events:all"
                                       class="murphy icon-wenhaoxiao g-color-3"></i>
                                </el-tooltip>
                            </template>
                            <div>
                                <el-switch inline-prompt v-model="formData1.is_global" active-text="是" inactive-text="否"
                        ...
                        <el-form-item label="自定义参数">
                            <div style="width: 100%;">
                                <el-input v-model="formData1.custom_parameters" maxlength="500" show-word-limit
                                          placeholder="请输入自定义参数"></el-input>
                            </div>
                        </el-form-item>
                    </FormComp>
                </div>
            ...
            <div class="part_content">
                <div class="form">
                    <FormComp label-position="top" :hide-required-asterisk="false">
                        ...
                        <div class="g-bdr-6 g-bg-f7 g-p-16" v-if="formData2.action === 'defect'">
            ...
            <div class="part_content">
                <div class="form">
                    <div class="form_title">
                        ...
                        <span @click="addCompHandle" class="button-text-blue">
                    ...
                    <div class="comp_item" v-for="(item, index) in formData3.comps" :key="index">
                        <div
                            ...
                            <div @click="removeCompHandle(index)" class="button-icon-grey">
                                <i class="murphy icon-shanchu"></i>
                            </div>
                    ...
                    <div class="g-bdr-6 g-p-16 g-bg-f7" v-if="formData2.action === 'mark'">
                        <FormComp label-position="top">
                            <el-form-item label="漏洞CVE编号">
                                <div style="width: 100%;">
                                    <el-select style="width: 100%;" remote multiple filterable allow-create
                            ...
                            <el-form-item label="漏洞是否存在 POC" class="g-mb-16">
                                <el-radio-group v-model="formData3.vuln.is_poc">
                            ...
                            <el-form-item label="漏洞是否可 RCE">
                                <el-radio-group v-model="formData3.vuln.is_rce">
                                    <el-radio :label="undefined">不启用该规则</el-radio>
                                    <el-radio :label="true">是</el-radio>
                                    <el-radio :label="false">否</el-radio>
                                </el-radio-group>
...
const formData1 = reactive<{
    ...
    custom_parameters: props.editData.custom_parameters,
});
...
const formData3 = reactive<{
    ...
    vuln: {
        ...
        mps: Array<string>,
        level: Array<number>,
        is_poc: boolean|undefined,
        is_rce: boolean|undefined,
    }
}>({
